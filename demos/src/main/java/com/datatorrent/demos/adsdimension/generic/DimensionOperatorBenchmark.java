 ...
 *
 */
@ApplicationAnnotation(name="DimensionOperatorBenchmark")
public class DimensionOperatorBenchmark implements StreamingApplication
{

  @Override
  public void populateDAG(DAG dag, Configuration conf)
  {
    dag.setAttribute(DAG.APPLICATION_NAME, "DimensionOperatorBenchmark");
